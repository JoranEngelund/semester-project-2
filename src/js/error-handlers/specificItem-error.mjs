/**
 * Handles the error that occurred during the specific-listings API call. Displays an error message and a button to refresh the page.
 * @param {error} error - The error object thrown during the listings API call
 * @returns {void}
 * @example
 * listingsErrorHandler(error);
 * @description
 * - The specificListingErrorHandler function handles the error that occurred during the listings API call.
 ...
 */
export function specificListingErrorHandler(error) {
  if (error) {
