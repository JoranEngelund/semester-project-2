/**
 * Handles the response of a profile listings API call and updates the UI accordingly.
 * @param {Response} response - The response object from the login request.
 * @example
 * profileListingsResponseHandler(response)
 * @description
 * - If the response is not ok, it displays an error message and a button to refresh the page.
 */
export function profileListingsResponseHandler(response) {
  if (!response.ok) {
